...
const info = [
  {
    name: "Место торжества",
    price: "10.07",
    period: ".2026",
    description: "Ресторан «Апельсин», г. Котлас",
    features: [
      "ул. Конституции, 1А",
      "Начало в 17:00",
      "Сбор гостей с 16:30",
      "Праздничный банкет и танцы",
    ],
  },
  {
    ...
    price: "до 01.07",
    period: "",
    description: "Ответьте ниже — мы ждём вас!",
    features: [
      "Укажите имена всех гостей",
      "Выберите блюда и напитки",
      "Соблюдайте дресс-код",
      "Нужна ли помощь с дорогой?",
    ],
    popular: true,
  },
]
